...
describe("GET /companies", function () {
  ...
  test("search with a filter", async function () {
    ...
    expect(resp.body.companies[0].numEmployees).toEqual(2)
  })
  ...
  test("search with all filters", async function () {
    ...
    expect(resp.body.companies[0].handle).toEqual("c2")
  })

  test("ignores invalid filters and still uses valid filters", async function () {
    const resp = await request(app).get('/companies').query({ nope: "nope", minEmployees: 3 })
    expect(resp.body.companies[0].handle).toEqual('c3')
  })
});
...
describe("GET /companies/:handle", function () {
  test("works for anon", async function () {
    ...
    expect(resp.body.company.jobs[0].equity).toEqual('0.1');
  });
